...
It has 3 overidable template methods- 
...
1. Use of smart-csv to support more efficient builk upload.

2. Support for updates- preferablly batch. 

3. Addition a pre and post process hooks 
